...
func (x *MemoCommand) Usage() string {
	return "[options] <the content of memo>"
}

func (x *MemoCommand) Execute(args []string) error {
	code, err := x.Run(args)
...
func (x *MemoCommand) Run(args []string) (int, error) {
	var content string
